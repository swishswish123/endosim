...
# -*- coding: utf-8 -*-
#
# endoSim documentation build configuration file, created by
...
# This allows modules to be indexed under the submodule name rather than all appearing under endosim
...
# The short X.Y version.
# version = endosim.__version__
# The full version, including alpha/beta/rc tags.
# release = endosim.__version__
...
latex_documents = [
    ('index', 'endoSim.tex',
     u'endoSim Documentation',
     u'Aure Enkaoua', 'manual'),
]
